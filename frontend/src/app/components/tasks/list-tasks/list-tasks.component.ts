...
//   {id: 2, nameTask: 'Tarea 2', description:'Description 2', dueDate:new Date('2018-01-10'), priorityTask:this.priority, status: true},
// ];
@Injectable()
@Component({
...
export class ListTasksComponent implements OnInit {
  ...
  // displayedColumns: string[] = ['id', 'demo-name', 'demo-description', 'expdate', 'priority','status', 'acciones'];
